...
import TopBar from '@/components/Dashboard/Main/Partials/TopBar';
...
const Main: React.FC<IMain> = ({ sidebarState }): JSX.Element => {
  return (
    ...
    >
      <TopBar />
      <div className='border-pylon h-auto min-h-[calc(100vh-13rem)] rounded-lg border-2 border-dashed p-4'>
        <StatsCards />
        <div className='mxslg:flex mxslg:flex-col mxslg:mt-[32rem] mxslg:h-[26rem] mxslg:mb-[1rem] mb-[4.25rem] grid h-[16.5rem] grid-cols-3 gap-4'>
