...
const TopBar: React.FC = (): JSX.Element => {
  ...
  return (
    <div className='exsm:flex-col my-4 flex w-full items-center justify-between gap-3'>
      <SearchInput />
      <button className='from-pylon to-sea exsm:w-full exsm:justify-center exsm:gap-2 relative inline-flex items-center rounded-lg bg-gradient-to-r p-2 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300'>
